...
default_hooks = dict(
    ...
    visualization=dict(type='TanmlhVisualizationHook', draw=True, interval=25, score_thr=0.1)
)
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'st-mask-rcnn-v3_fft_ema_st-rpn_r50_100e_planet_basemap_sample-global-small',
            resume = 'never',
            dir = './work_dirs/',
