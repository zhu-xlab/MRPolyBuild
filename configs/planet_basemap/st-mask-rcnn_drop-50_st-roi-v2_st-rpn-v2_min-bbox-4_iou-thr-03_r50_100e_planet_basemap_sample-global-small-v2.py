_base_ = [
    '../_base_/datasets/planet_basemap_2023q2_sample-global-small-v2.py', '../_base_/default_runtime.py',
]
...
val_evaluator = [
    dict(
        ...
        # metric=['bbox'],
        metric=['proposal_fast', 'bbox_fast'],
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'st-mask-rcnn_drop-50_st-roi-v2_st-rpn-v2_min-bbox-4_iou-thr-03_r50_100e_planet_basemap_sample-global-small-v2',
            resume = 'never',
            dir = './work_dirs/',
