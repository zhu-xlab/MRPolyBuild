_base_ = [
    '../_base_/datasets/planet_basemap_2023q2_sample-global-small-stuff.py', '../_base_/default_runtime.py',
]
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'test_mask2former_r50_query-10_50e_planet_basemap_sample-europe',
            resume = 'never',
            dir = './work_dirs/',
