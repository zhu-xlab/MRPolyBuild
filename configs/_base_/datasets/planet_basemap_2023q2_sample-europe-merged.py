...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # split='train'
        ann_file = 'coco_ann/merged_douglas_global_quartely_2023q2.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2_test_sample/with_ann',
        # ann_file = 'coco_ann/small_merged_douglas_global_quartely_2023q2.json',
        ann_file = 'coco_ann/small_merged_douglas_global_quartely_2023q2.json',
