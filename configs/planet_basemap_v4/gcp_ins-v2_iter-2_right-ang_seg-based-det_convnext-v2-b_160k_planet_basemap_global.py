...
load_from = 'work_dirs/seg-based-det_multi-source_convnext-v2-b_50e_planet_basemap_global/epoch_29.pth'
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'gcp_ins-v2_iter-2_right-ang_seg-based-det_convnext-v2-b_160k_planet_basemap_global',
            resume = 'never',
            dir = './work_dirs/',
