_base_ = [
    '../_base_/datasets/planet_basemap_large-scene_8x_2023q2_sining-230k.py',
...
model = dict(
    ...
    test_cfg=dict(
        inf_cfg=dict(
            mode='slide', crop_size=(128, 128), stride=(96, 96),
            crop_up_size=(128 * 8, 128 * 8),
...
save_cfg=dict(
    save_results=True,
    out_dir = '/home/fahong/Datasets/ai4eo3/Global3D_v2/train_data/height_230k',
    out_poly_scale=1/8.,
)
