...
# load_from = 'work_dirs/st-mask-rcnn_no-drop_min-bbox-2_no-bbox_r50_20e_planet_basemap_sample-global-small/epoch_10.pth'
model = dict(
    type='STMaskRCNN',
...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file = '/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2_test_sample/coco_ann/medellin.json',
        # metric=['bbox'],
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'test_gcp_st-mask-rcnn_no-drop_min-bbox-2_no-bbox_r50_20e_planet_basemap_sample-global-small',
            resume = 'never',
            dir = './work_dirs/',
