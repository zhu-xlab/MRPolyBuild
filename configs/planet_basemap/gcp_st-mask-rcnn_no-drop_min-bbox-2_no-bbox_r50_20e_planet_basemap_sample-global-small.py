...
load_from = 'work_dirs/st-mask-rcnn_no-drop_min-bbox-2_no-bbox_r50_20e_planet_basemap_sample-global-small/epoch_15.pth'
model = dict(
    type='STMaskRCNN',
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'gcp_st-mask-rcnn_no-drop_min-bbox-2_no-bbox_r50_20e_planet_basemap_sample-global-small',
            resume = 'never',
            dir = './work_dirs/',
