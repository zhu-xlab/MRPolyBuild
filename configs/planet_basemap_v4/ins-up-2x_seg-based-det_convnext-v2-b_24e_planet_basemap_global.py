...
load_from = 'work_dirs/seg-based-det_convnext-v2-b_50e_planet_basemap_global/epoch_9.pth'
    ...
    seg_poly_head=dict(
        ...
        seg2ins_head=dict(
            ...
            poly_roi_extractor=dict(
                type='MultiLevelRoIExtractor',
                roi_layers=[
                    dict(type='RoIAlign', output_size=16, sampling_ratio=0)
                    dict(type='RoIAlign', output_size=64, sampling_ratio=0)
                ],
                out_channels=256,
                featmap_strides=[1]
            ),
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'ins-up-2x_seg-based-det_convnext-v2-b_24e_planet_basemap_global',
            resume = 'never',
            dir = './work_dirs/',
