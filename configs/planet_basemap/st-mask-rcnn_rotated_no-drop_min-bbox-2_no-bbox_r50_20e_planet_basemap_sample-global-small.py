_base_ = [
    '../_base_/datasets/planet_basemap_2023q2_rotated_global-small_1024.py', '../_base_/default_runtime.py',
]
...
model = dict(
    ...
    roi_head=dict(
        ...
        #     roi_layer=dict(type='RoIAlignRotated', output_size=18, sampling_ratio=0),
        #     out_channels=256,
        #     featmap_strides=[4, 8, 16, 32]),
        mask_head=dict(
            type='FCNMaskHead',
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'st-mask-rcnn_rotated_no-drop_min-bbox-2_no-bbox_r50_20e_planet_basemap_sample-global-small',
            resume = 'never',
            dir = './work_dirs/',
...
train_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file = 'coco_ann_full/rotated_small_train_global_quartely_2023q2.json',
        # ann_file = 'coco_ann_full/small_rotated_merged_filtered_test_dp_global_quartely_2023q2.json',
        min_bbox_w=2,
        # drop_rate=0.2
    )
)
