_base_ = [
    '../_base_/datasets/planet_basemap_single_ann_2023q2_global_8x_train-160k.py', '../_base_/default_runtime.py',
]
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_dir = '/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2_v3/train/merged_ann',
        ann_cfg=dict(
