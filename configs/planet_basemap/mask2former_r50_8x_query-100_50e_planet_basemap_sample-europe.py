_base_ = [
    '../_base_/datasets/planet_basemap_2023q2_sample-europe_8x.py', '../_base_/default_runtime.py',
]
...
model = dict(
    ...
    test_cfg=dict(
        ...
        inf_cfg=dict(
            mode='slide', crop_size=(64, 64), stride=(64, 64),
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'mask2former_r50_8x_query-100_50e_planet_basemap_sample-europe',
            resume = 'never',
            dir = './work_dirs/',
