...
model = dict(
    ...
    panoptic_head=dict(
        ...
        loss_cls=dict(
            ...
            loss_weight=2.0,
            reduction='mean',
            class_weight=[10.0] * num_classes + [1.0]),
        loss_mask=dict(
            type='CrossEntropyLoss',
            use_sigmoid=True,
            reduction='mean',
        ...
        loss_seg=dict(
            ...
            use_sigmoid=False,
            reduction='mean',
            class_weight=[2.0] * num_classes + [1.0],
            loss_weight=5.0)),
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'test_mask2former_r50_seg-loss_single-level_query-512_100e_planet_basemap_sample-europe',
            resume = 'never',
            dir = './work_dirs/',
