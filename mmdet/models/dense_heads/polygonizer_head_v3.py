...
class PolygonizerHeadV3(MaskFormerHead):
    ...
    def _get_poly_targets(self, poly_preds, poly_gt_jsons):
        ...
        if len(poly_preds) == 0:
            return torch.zeros(0, self.num_primitive_queries, dtype=torch.long), torch.zeros(0, self.num_primitive_queries, 2)
    ...
    def predict(self, x: Tuple[Tensor],
        ...
        return mask_cls_results, mask_pred_results, batch_polygons
