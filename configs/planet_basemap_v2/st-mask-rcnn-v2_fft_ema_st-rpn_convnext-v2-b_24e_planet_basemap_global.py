...
load_from = 'work_dirs/st-mask-rcnn-v2_fft_ema_st-rpn_convnext-v2-b_50e_planet_basemap_global/epoch_20.pth'
model = dict(
    type='STMaskRCNN',
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'st-mask-rcnn-v2_fft_ema_st-rpn_convnext-v2-b_24e_planet_basemap_global',
            resume = 'never',
            dir = './work_dirs/',
