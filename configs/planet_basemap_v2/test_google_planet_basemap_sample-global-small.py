...
model = dict(
    ...
    rpn_head=dict(
        ...
        st_cfg=dict(
            ...
            memory_size=2,
            warm_up_iter=-1, # do not apply thresholding
            alpha_memory=0.99,
...
default_hooks = dict(
    checkpoint=dict(
        ...
        interval=5),
    ema=dict(
        type='EMAHook', momentum=0.001, interval=1
    ),
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'test_google_st-mask-rcnn-v2_ema_r50_100e_planet_basemap_sample-global-small',
            resume = 'never',
            dir = './work_dirs/',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file = 'coco_ann_full/small_merged_filtered_test_dp_global_quartely_2023q2.json',
        # ann_file = 'coco_ann_full/small_merged_small_train_dp_global_quartely_2023q2.json',
        ann_file = 'coco_ann_google/google_2023q2.json',
        min_bbox_w=2,
        # drop_rate=0.2
    )
)
...
test_dataloader = dict(
    dataset=dict(
        ...
        # ann_file = 'coco_ann_full/small_merged_filtered_test_dp_global_quartely_2023q2.json',
        ann_file = 'coco_ann_global/upscale_merged_test_continent_global_quartely_2023q2.json',
        min_bbox_w=2
    )
)
