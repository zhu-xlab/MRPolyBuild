_base_ = [
    '../_base_/datasets/planet_basemap_single_ann_2023q2_global_8x_test-16k.py',
...
save_cfg=dict(
    save_results=True,
    out_dir = '/home/fahong/Datasets/ai4eo3/Global3D_v2/inference_results/polygons/gcp_right-v2_50e_8x_test-16k',
    out_poly_scale=1/8.,
)
