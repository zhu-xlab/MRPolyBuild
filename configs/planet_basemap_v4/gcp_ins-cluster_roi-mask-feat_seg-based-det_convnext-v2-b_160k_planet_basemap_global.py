...
# load_from = 'work_dirs/seg-based-det_convnext-v2-b_50e_planet_basemap_global/epoch_19.pth'
load_from = 'work_dirs/seg-based-det_multi-source_convnext-v2-b_50e_planet_basemap_global/epoch_19.pth'
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'gcp_ins-cluster_roi-mask-feat_seg-based-det_convnext-v2-b_80k_planet_basemap_global',
            resume = 'never',
            dir = './work_dirs/',
