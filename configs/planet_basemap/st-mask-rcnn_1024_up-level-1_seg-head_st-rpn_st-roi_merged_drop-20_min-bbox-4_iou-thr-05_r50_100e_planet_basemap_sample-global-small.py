...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_bbox=dict(type='L1Loss', loss_weight=1.0),
            loss_dom_score=dict(type='L1Loss', loss_weight=10.0)),
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'st-mask-rcnn_1024_up-level-1_seg-head_st-rpn_st-roi_merged_drop-20_min-bbox-4_iou-thr-05_r50_100e_planet_basemap_sample-global-small',
            resume = 'never',
            dir = './work_dirs/',
