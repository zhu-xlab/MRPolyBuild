_base_ = [
    '../_base_/datasets/planet_basemap_2023q2_sample-global.py', '../_base_/default_runtime.py',
]
...
val_evaluator = [
    dict(
        ...
        ann_file = '/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2/coco_ann/upscale_global_quartely_2023q2.json',
        metric=['segm'],
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'st-mask-rcnn_st-rpn-v2_min-bbox-2_iou-thr-03_r50_100e_planet_basemap_sample-global',
            resume = 'never',
            dir = './work_dirs/',
