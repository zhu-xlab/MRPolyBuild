_base_ = [
    '../_base_/datasets/planet_basemap_2023q2_1024_sample-global-small.py', '../_base_/default_runtime.py',
]
...
model = dict(
    ...
    panoptic_head=dict(
        ...
        #     roi_layer=dict(type='RoIAlign', output_size=256, sampling_ratio=0),
        #     out_channels=256,
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'test_st_mask2former_r50_query-20_50e_planet_basemap_sample-europe',
            resume = 'never',
            dir = './work_dirs/',
