...
class MSDeformAttnPixelDecoderV2(BaseModule):
    ...
    def forward(self, feats: List[Tensor]) -> Tuple[Tensor, Tensor]:
        ...
        point_feature = self.point_feature(outs[-1])
        return mask_feature, point_feature, multi_scale_features
