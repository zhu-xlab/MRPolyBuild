...
class STRotatedRPNHead(AnchorHead):
    ...
    def _bbox_post_process(self,
        ...
        assert results.bboxes.shape[-1] == 5
        if rescale:
    ...
    def _get_targets_single(self,
        ...
        hbb_gt_instances = gt_instances.clone()
        hbb_gt_instances.bboxes = obb2xyxy(hbb_gt_instances.bboxes)

        assign_result = self.assigner.assign(pred_instances, hbb_gt_instances, gt_instances_ignore)
