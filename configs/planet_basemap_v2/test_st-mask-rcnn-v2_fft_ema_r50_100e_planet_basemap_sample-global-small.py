...
val_evaluator = [
    dict(
        ...
        out_cfg=dict(
            ...
            out_size=(256, 256),
            save_coco=True,
            saved_coco_path='./work_dirs/basemap_pred_results/st-mark-rcnn-v2/fft-ema.json'
        ),
        min_bbox_size=8,
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'st-mask-rcnn_small-v2_up-all_fft_ema_iou07_no-drop_min-bbox-2_no-bbox_r50_100e_planet_basemap_sample-global-small',
            resume = 'never',
            dir = './work_dirs/',
