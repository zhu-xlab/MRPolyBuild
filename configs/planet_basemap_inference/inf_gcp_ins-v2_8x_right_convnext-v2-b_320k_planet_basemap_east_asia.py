_base_ = [
    '../_base_/datasets/planet_basemap_large-scene_8x_2023q2_east_asia.py',
...
save_cfg=dict(
    save_results=True,
    out_dir = '/home/fahong/Datasets/ai4eo3/Global3D_v2/inference_results/polygons/gcp_50e_8x',
    out_poly_scale=1/8.,
)
