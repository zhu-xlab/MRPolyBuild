_base_ = [
    '../_base_/datasets/planet_basemap_large-scene_4x_2023q2_sample-europe.py',
    '../_base_/default_runtime.py',
]

custom_imports = dict(
    imports=['mmpretrain.models'], allow_failed_imports=False)
load_from = 'work_dirs/gcp_ins-v2_right-ang_seg-based-det_convnext-v2-b_160k_planet_basemap_global/iter_56000.pth'
...
save_cfg=dict(
    save_results=True,
    out_dir='./work_dirs/basemap_pred_results/inf_gcp_ins_v2_4x',
    out_poly_scale=1/4.,
)
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'gcp_ins-v2_4x_right-ang_seg-based-det_convnext-v2-b_320k_planet_basemap_global',
            resume = 'never',
            dir = './work_dirs/',
