...
load_from = 'work_dirs/gcp_ins-v2_8x_late-stop_right-ang-v2_seg-based-det_convnext-v2-b_160k_planet_basemap_global/iter_160000.pth'
...
save_cfg=dict(
    save_results=True,
    out_dir = '/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2_v3/test_6k/gcp_late-stop',
    out_poly_scale=1/8.,
)
