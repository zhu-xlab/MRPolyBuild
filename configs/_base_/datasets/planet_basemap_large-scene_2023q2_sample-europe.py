...
data_root = '/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2_test_sample/'
img_norm_cfg = dict(
...
test_pipeline = [
    ...
    dict(type='LoadTIFMetaInfo'),
    # dict(type='Resize', scale=(1024, 1024), keep_ratio=True),
    # dict(type='Pad', size=(1024 + 128, 1024 + 128), padding_mode='constant'),
    # dict(type='CenterPadImage', size=(1024 + 128, 1024 + 128)),
    # dict(type='RandomCrop', crop_size=crop_size),
    dict(
        type='PackDetInputs',
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
