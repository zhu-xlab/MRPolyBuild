...
class SegBasedDetector(BaseDetector):
    ...
    def predict_sem_seg(
        ...
        batch_data_samples[0].merged_sem_seg_list = merged_sem_seg_list
        batch_data_samples[0].mask_shape = (out_h, out_w)
    ...
    def predict_mosaic_sem_seg(self, imgs, batch_data_samples):
        ...
        del batch_data_samples[0].mask_shape
    ...
    def predict(self,
        ...
        batch_data_samples = self.predict_sem_seg(batch_inputs, batch_data_samples, rescale)
        batch_data_samples = self.predict_mosaic_sem_seg(batch_inputs, batch_data_samples)
        results = self.seg_poly_head.predict(batch_inputs, batch_data_samples)
