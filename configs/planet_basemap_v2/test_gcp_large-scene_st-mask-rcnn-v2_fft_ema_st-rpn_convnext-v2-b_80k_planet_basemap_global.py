_base_ = [
    '../_base_/datasets/planet_basemap_large-scene_2023q2_sample-europe.py', '../_base_/default_runtime.py',
]
...
model = dict(
    ...
    test_cfg=dict(
        ...
        inf_cfg=dict(
            ...
            pad_size=(4096 + 64, 4096 + 64),
            out_pad_size=((4096 + 64) * 4, (4096 + 64) * 4),
            out_size=(4096 * 4, 4096 * 4), out_size_scale=1.,
            # filter_border_width = 128,
            filter_border_width = 128,
            split_batch_size=4,
            merge_instance_with_sem_seg=True,
        ),
        post_cfg = dict(
            type='InstancePostProcessor',
            out_size=(4096 * 4, 4096 * 4),
...
val_evaluator = [
    dict(
        ...
        ann_file = '/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2_test_sample/coco_ann/ketchican.json',
        # ann_file = '/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2_test_sample/coco_ann/GUF04_DLR_v02_w135_n60_w130_n55_OGR06.json',
        # metric=['bbox'],
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'gcp_st-mask-rcnn-v2_fft_ema_st-rpn_convnext-v2-b_80k_planet_basemap_global',
            resume = 'never',
            dir = './work_dirs/',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file = 'coco_ann/ketchican.json',
...
test_dataloader = dict(
    dataset=dict(
        ...
        ann_file = 'coco_ann/medellin.json',
        # ann_file = 'coco_ann/munich.json',
        # ann_file = 'coco_ann/GUF04_DLR_v02_w135_n60_w130_n55_OGR06.json',
        min_bbox_w=2
    )
)
