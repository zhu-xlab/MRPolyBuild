...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file = '/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2_sample/coco_ann/global_quartely_2023q2.json',
        metric=['segm'],
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'mask-rcnn_r50_query-100_12e_planet_basemap',
            resume = 'never',
            dir = './work_dirs/',
