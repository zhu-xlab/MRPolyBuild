...
# train_cfg = dict(type='IterBasedTrainLoop', max_iters=40000 * 50, val_interval=5000)
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'st-mask-rcnn-v2_partial-sample_fft_ema_st-rpn_convnext-v2-b_50e_planet_basemap_global',
            resume = 'never',
            dir = './work_dirs/',
