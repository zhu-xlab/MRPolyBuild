_base_ = [
    '../_base_/datasets/planet_basemap_large-scene_4x_2023q2_test-6k.py',
    '../_base_/default_runtime.py',
]

custom_imports = dict(
    imports=['mmpretrain.models'], allow_failed_imports=False)
# load_from = 'work_dirs/gcp_ins-v2_4x_seg-based-det_convnext-v2-b_320k_planet_basemap_global/iter_320000.pth'
load_from = 'work_dirs/gcp_ins-v2_4x_right-ang-v2_seg-based-det_convnext-v2-b_160k_planet_basemap_global/iter_144000.pth'
...
model = dict(
    ...
    test_cfg=dict(
        inf_cfg=dict(
            ...
            out_size=None, out_size_scale=4.,
...
save_cfg=dict(
    save_results=True,
    out_dir = '/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2_v3/test_6k/gcp_4x',
    out_poly_scale=1/4.,
)
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'gcp_ins-v2_seg-based-det_convnext-v2-b_320k_planet_basemap_global',
            resume = 'never',
            dir = './work_dirs/',
