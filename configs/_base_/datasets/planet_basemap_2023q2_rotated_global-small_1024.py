...
train_pipeline = [
    ...
    dict(type='LoadAnnotations', with_bbox=True, with_mask=True, poly2mask=False, with_poly_json=False, box_type='rbox'),
...
test_pipeline = [
    dict(type='LoadImageFromFile', backend_args=backend_args),
    dict(type='LoadAnnotations', with_bbox=True, with_mask=False, poly2mask=False, with_poly_json=False, box_type='rbox'),
    dict(type='LoadTIFMetaInfo'),
    dict(type='Resize', scale=(1024, 1024), keep_ratio=True),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file = 'coco_ann_full/rotated_merged_small_train_global_quartely_2023q2.json',
