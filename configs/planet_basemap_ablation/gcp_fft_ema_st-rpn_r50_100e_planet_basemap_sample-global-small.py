...
load_from = 'work_dirs/st-mask-rcnn-v2_fft_ema_st-rpn_r50_100e_planet_basemap_sample-global-small/epoch_100.pth'
model = dict(
    type='STMaskRCNN',
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            entity = 'tum-tanmlh',
            name = 'gcp_fft_ema_st-rpn_r50_100e_planet_basemap_sample-global-small',
            resume = 'never',
            dir = './work_dirs/',
