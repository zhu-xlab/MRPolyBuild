...
class PolygonizerHeadV13(MaskFormerHead):
    ...
    def _get_poly_targets_single(self, poly_pred_json, poly_gt_json):

        targets = {}

        poly_pred = torch.tensor(poly_pred_json['coordinates'][0]).float() # use the exterior
